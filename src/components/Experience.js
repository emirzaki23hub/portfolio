  ...
  return (
    <section id="Experience" className="bg-white py-20">
      <div className="container mx-auto">
        <h1 className="text-6xl max-w-lg font-bold text-gray-500  dark:text-gray-600 text-center lg:text-left">
          Experience
        </h1>
      </div>
...
const ExperienceCard = ({ title, desc, year, company, companyLink }) => {
  return (
    <div className="relative experience-card border p-4 rounded-md shadow-xl bg-white z-10 mx-4">
      <h1 className="absolute -top-10 md:-left-10 md:-top-10 text-4xl text-gray-200 font-bold mb-5 dark:text-gray-800">
        {year}
      </h1>
